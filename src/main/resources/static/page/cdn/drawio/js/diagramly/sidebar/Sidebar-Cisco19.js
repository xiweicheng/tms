...
(function()
{
	...
	Sidebar.prototype.addCisco19LANSwitchingPalette = function(s, s2, s3)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'rect;prIcon=l3_modular2;fillColorStyles=fillColor2;fillColor2=#e6a9ab;fillColor=#FAFAFA;strokeColor=#005073;', 
					w, h * 1.3, '', 'L3 Modular', null, null, this.getTagsForStencil(gn, 'l3 modular', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=6500_vss2;fillColorStyles=fillColor2;fillColor2=#e6a9ab;fillColor=#FAFAFA;strokeColor=#005073;', 
					w, h * 1.3, '', '6500 VSS', null, null, this.getTagsForStencil(gn, '6500 vss', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=secure_catalyst_switch_color;fillColorStyles=fillColor2;fillColor2=#e6a9ab;fillColor=#FAFAFA;strokeColor=#005073;', 
					w, h, '', 'Secure Catalyst Switch (color)', null, null, this.getTagsForStencil(gn, 'secure catalyst switch color', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=secure_catalyst_switch_color;fillColorStyles=fillColor2,fillColor3;fillColor2=#e6a9ab;fillColor3=#fafafa;fillColor=#fafafa;strokeColor=#005073;', 
					w, h, '', 'Secure Catalyst Switch (color)', null, null, this.getTagsForStencil(gn, 'secure catalyst switch color', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=secure_catalyst_switch_subdued;fillColorStyles=fillColor2;fillColor2=#005073;fillColor=#FAFAFA;strokeColor=#6696AB;', 
			...
			this.createVertexTemplateEntry(s + 'rect;prIcon=secure_catalyst_switch_color3;fillColorStyles=fillColor2,fontColor2;fillColor2=#e6a9ab;fontColor2=#ffffff;fillColor=#FAFAFA;strokeColor=#005073;', 
					w, h, '', 'Secure Catalyst Switch (color)', null, null, this.getTagsForStencil(gn, 'secure catalyst switch color', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=secure_catalyst_switch_color2;fillColorStyles=fillColor2;fillColor2=#e6a9ab;fillColor=#FAFAFA;strokeColor=#005073;', 
					w, h, '', 'Secure Catalyst Switch (color)', null, null, this.getTagsForStencil(gn, 'secure catalyst switch color', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=secure_catalyst_switch_subdued2;fillColorStyles=fontColor2;fontColor2=#ffffff;fillColor=#FAFAFA;strokeColor=#6696AB;', 
					w, h, '', 'Secure Catalyst Switch (subdued)', null, null, this.getTagsForStencil(gn, 'secure catalyst switch subdued', dt).join(' '))
		]);
	};
	...
	Sidebar.prototype.addCisco19DataCenterPalette = function(s, s2, s3)
	{
		...
		[
			...
			this.createVertexTemplateEntry('points=[[0.015,0.015,0],[0.25,0,0],[0.5,0,0],[0.75,0,0],[0.985,0.015,0],[1,0.22,0],[1,0.44,0],[1,0.67,0],[0.985,0.89,0],[0,0.22,0],[0,0.44,0],[0,0.67,0],[0.015,0.89,0],[0.25,0.91,0],[0.5,0.91,0],[0.785,0.955,0]];' + s3 + 'x509_certificate2;fillColor=#FAFAFA;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry('points=[[0.5,0,0],[1,0.5,0],[0.5,1,0],[0,0.5,0],[0.305,0.305,0],[0.695,0.305,0],[0.7,0.7,0],[0.3,0.7,0]];' + s3 + 'rect;prIcon=aci2;fillColorStyles=fillColor2;fillColor=#fafafa;strokeColor=#005073;fillColor2=#fafafa;', 
					w, h, '', 'ACI', null, null, this.getTagsForStencil(gn, 'aci', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'rect;prIcon=vts2;fillColor=#FAFAFA;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry(s + 'server2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 0.55, h, '', 'Server', null, null, this.getTagsForStencil(gn, 'server', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'dns_server2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 0.55, h, '', 'DNS Server', null, null, this.getTagsForStencil(gn, 'dns domain name server', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'secure_server2;fillColor=#fafafa;strokeColor=#005073;', 
	...
	Sidebar.prototype.addCisco19WirelessLANPalette = function(s, s2, s3)
	{
		...
		[
			...
			this.createVertexTemplateEntry('points=[[0.03,0.36,0],[0.18,0,0],[0.5,0.34,0],[0.82,0,0],[0.97,0.36,0],[1,0.67,0],[0.975,0.975,0],[0.5,1,0],[0.025,0.975,0],[0,0.67,0]];' + s3 + 'wireless_access_point2;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry(s + 'wireless_bridge2;fillColor=#fafafa;strokeColor=#005073;', 
	...
	Sidebar.prototype.addCisco19CollaborationPalette = function(s, s2, s3)
	{
		...
		[
			...
			this.createVertexTemplateEntry('points=[[0.13,0.225,0],[0.5,0,0],[0.87,0.225,0],[0.885,0.5,0],[0.985,0.99,0],[0.5,1,0],[0.015,0.99,0],[0.115,0.5,0]];' + s3 + 'laptop_video_client2;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry('points=[[0,0,0],[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0,0],[1,0.4,0],[1,0.8,0],[0.815,1,0],[0.5,1,0],[0.185,1,0],[0,0.8,0],[0,0.4,0]];' + s3 + 'hdtv2;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry(s + 'rect;prIcon=telepresence_exchange;fillColorStyles=fillColor2;fillColor2=#00bceb;fillColor=#FAFAFA;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry(s + 'rect;prIcon=communications_manager;fillColorStyles=fillColor2;fillColor2=#ffffff;fillColor=#FAFAFA;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry('points=[[0.015,0.015,0],[0.5,0,0],[0.985,0.015,0],[1,0.22,0],[0.985,0.43,0],[0.73,0.85,0],[0.5,1,0],[0.285,0.85,0],[0.015,0.43,0],[0,0.22,0]];' + s3 + 'surveillance_camera2;fillColorStyls=fillColor2;fillColor2=#00bceb;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry('points=[[0.13,0.225,0],[0.5,0,0],[0.87,0.225,0],[0.885,0.5,0],[0.985,0.99,0],[0.5,1,0],[0.015,0.99,0],[0.115,0.5,0]];' + s3 + 'upc_unified_personal_communicator2;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry(s + 'rect;prIcon=ip_ip_gateway;fillColorStyles=fillColor2;fillColor2=#00bceb;fillColor=#FAFAFA;strokeColor=#005073;', 
					w * 1.28, h, '', 'IP IP Gateway', null, null, this.getTagsForStencil(gn, 'ip gateway', dt).join(' ')),
			this.createVertexTemplateEntry(s2 + 'webex;fillColorStyles=fillColor2;strokeColorStyles=strokeColor2;fillColor2=#92be70;strokeColor2=#78af4e;fillColor=#2c96c9;strokeColor=#0d87c1;', 
			...
			this.createVertexTemplateEntry('points=[[0.5,0,0],[0.75,0.37,0],[0.96,0.735,0],[0.5,1,0],[0.045,0.73,0],[0.25,0.37,0]];' + s3 + 'phone_polycom2;fillColorStyles=fillColor2;fillColor2=#00bceb;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry(s + 'rect;prIcon=set_top2;fillColor=#FAFAFA;strokeColor=#005073;', 
					w * 1.28, h, '', 'Set Top', null, null, this.getTagsForStencil(gn, 'set top', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.59,0,0],[0.87,0.015,0],[0.88,0.3,0],[0.99,0.99,0],[0.5,1,0],[0.01,0.99,0],[0.075,0.5,0],[0.17,0.115,0]];' + s3 + 'ip_phone2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 1.15, h, '', 'IP Phone', null, null, this.getTagsForStencil(gn, 'ip phone internet protocol', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0,0.5,0],[0.19,0.02,0],[0.59,0,0],[0.985,0.02,0],[1,0.5,0],[0.985,0.98,0],[0.59,1,0],[0.19,0.98,0]];' + s3 + 'camera2;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry('points=[[0.13,0.24,0],[0.5,0.2,0],[0.62,0,0],[0.87,0.24,0],[0.95,0.55,0],[0.96,0.95,0],[0.5,1,0],[0.04,0.95,0],[0.05,0.55,0]];' + s3 + 'joystick_keyboard2;fillColor=#fafafa;strokeColor=#005073;', 
	...
	Sidebar.prototype.addCisco19SecurityCloudsAndConnectorsPalette = function(s, s2, s3)
	{
		...
		[
			...
			this.createVertexTemplateEntry('points=[[0.5,0,0],[0.765,0.48,0],[0.99,0.98,0],[0.5,1,0],[0.01,0.98,0],[0.235,0.48,0]];' + s3 + 'ldap2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.85, '', 'LDAP', null, null, this.getTagsForStencil(gn, 'ldap', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0,0.5,0],[0.24,0,0],[0.5,0.28,0],[0.995,0.475,0],[0.5,0.72,0],[0.24,1,0]];' + s3 + 'key2;fillColor=none;strokeColor=#005073;', 
					w, h * 0.45, '', 'Key', null, null, this.getTagsForStencil(gn, 'key', dt).join(' ')),
			this.createVertexTemplateEntry(s2 + 'lock2;fillColor=#fafafa;strokeColor=#005073;', 
			...
			this.createVertexTemplateEntry('points=[[0.13,0.02,0],[0.5,0,0],[0.87,0.02,0],[0.885,0.4,0],[0.985,0.985,0],[0.5,1,0],[0.015,0.985,0],[0.115,0.4,0]];' + s3 + 'secure_endpoints2;fillColor=#fafafa;strokeColor=#005073;', 
	...
	Sidebar.prototype.addCisco19EndpointClientDeviceIconsPalette = function(s, s2, s3)
	{
		...
		[
			this.createVertexTemplateEntry('points=[[0.03,0.03,0],[0.5,0,0],[0.97,0.03,0],[1,0.4,0],[0.97,0.745,0],[0.5,1,0],[0.03,0.745,0],[0,0.4,0]];' + s3 + 'workstation2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.8, '', 'Workstation', null, null, this.getTagsForStencil(gn, 'workstation', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.13,0.02,0],[0.5,0,0],[0.87,0.02,0],[0.885,0.4,0],[0.985,0.985,0],[0.5,1,0],[0.015,0.985,0],[0.115,0.4,0]];' + s3 + 'laptop2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.7, '', 'Laptop', null, null, this.getTagsForStencil(gn, 'laptop', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'handheld2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 0.75, h, '', 'Handheld', null, null, this.getTagsForStencil(gn, 'handheld', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'cell_phone2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 0.5, h, '', 'Cell Phone', null, null, this.getTagsForStencil(gn, 'cell phone', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.015,0.14,0],[0.5,0,0],[0.985,0.14,0],[1,0.57,0],[0.99,0.98,0],[0.5,1,0],[0.01,0.98,0],[0,0.57,0]];' + s3 + 'tablet2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.8, '', 'Tablet', null, null, this.getTagsForStencil(gn, 'tablet', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.22,0.185,0],[0.5,0,0],[0.78,0.185,0],[0.975,0.49,0],[1,0.73,0],[0.975,0.97,0],[0.5,1,0],[0.025,0.97,0],[0,0.73,0],[0.025,0.49,0]];' + s3 + 'printer2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.9, '', 'Printer', null, null, this.getTagsForStencil(gn, 'printer', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'pos2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 1.28, h, '', 'POS', null, null, this.getTagsForStencil(gn, 'pos', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.115,0.05,0],[0.335,0,0],[0.98,0.52,0],[1,0.71,0],[0.68,1,0],[0.065,0.76,0],[0,0.33,0],[0.68,0.33,0]];' + s3 + 'home_office2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h, '', 'Home Office', null, null, this.getTagsForStencil(gn, 'home office', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.35,0,0],[0.98,0.51,0],[1,0.71,0],[0.67,1,0],[0,0.795,0],[0,0.65,0]];' + s3 + 'user2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h, '', 'User', null, null, this.getTagsForStencil(gn, 'user', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.02,0.015,0],[0.5,0,0],[0.98,0.015,0],[1,0.38,0],[0.895,0.98,0],[0.5,1,0],[0.105,0.98,0],[0,0.38,0]];' + s3 + 'secure_endpoint_pc2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.8, '', 'Secure Endpoint (PC)', null, null, this.getTagsForStencil(gn, 'secure endpoints pc', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.13,0.02,0],[0.5,0,0],[0.87,0.02,0],[0.885,0.4,0],[0.985,0.985,0],[0.5,1,0],[0.015,0.985,0],[0.115,0.4,0]];' + s3 + 'secure_endpoints2;fillColor=#fafafa;strokeColor=#005073;', 
					w, h * 0.7, '', 'Secure Endpoint (laptop)', null, null, this.getTagsForStencil(gn, 'secure endpoints laptop', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0.5,0,0],[1,0.34,0],[1,1],[0.75,1,0],[0.5,1,0],[0.25,1,0],[0,1,0],[0,0.34,0],[1,0.67,0],[0,0.67,0],[0.325,0,0],[0.675,0,0]];' + s3 + 'data_center2;fillColor=#fafafa;strokeColor=#005073;', 
					w * 2, h * 1.4, '', 'Data Center', null, null, this.getTagsForStencil(gn, 'data center', dt).join(' ')),
			this.createVertexTemplateEntry('points=[[0,0,0],[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0,0],[1,0.25,0],[1,0.5,0],[1,0.75,0],[1,1,0],[0.75,1,0],[0.5,1,0],[0.25,1,0],[0,1,0],[0,0.75,0],[0,0.5,0],[0,0.25,0]];' + s3 + 'branch2;fillColor=#fafafa;strokeColor=#005073;', 
	...
	Sidebar.prototype.addCisco19StealthwatchPalette = function(s, s2, s3)
	{
		...
		[
			...
			this.createVertexTemplateEntry('points=[[0.03,0.03,0],[0.5,0,0],[0.97,0.03,0],[1,0.4,0],[0.97,0.745,0],[0.5,1,0],[0.03,0.745,0],[0,0.4,0]];' + s3 + 'stealthwatch_management_console_smc2;fillColor=#fafafa;strokeColor=#005073;', 
