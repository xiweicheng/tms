...
public final class StringUtil {
     ...
     *
     * @param tpl string like xxxx{key}yyy{key}zzzz
     * @param map
     * @return
     * @author xiweicheng
    ...
    public static String replaceByMap(String tpl, Map<String, Object> map) {
        ...
        if (tpl != null && map != null && map.size() > 0) {
            ...
            for (Map.Entry<String, Object> es : map.entrySet()) {
                tpl = tpl
                        .replace("{" + es.getKey() + "}", String.valueOf(es.getValue()));
            }
     ...
     *
     * @param tpl  string like xxxx{key}yyy{key}zzzz
     * @param vals key:value pair like k1, v1, k2, v2 ...
     * @return
     * @author xiweicheng
    ...
    public static String md2Html(String markdown, boolean parseMd, boolean noCss) {
        ...
        sb.append(parseMd ? StringUtil.mdParse(markdown) : markdown);
        sb.append("</div>");
        return sb.toString();
    }
